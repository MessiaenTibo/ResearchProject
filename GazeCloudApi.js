...
var GazeCloudAPI = new (function GazeCloudAPIInit() {
    ...
    try {
      ...
      for (var i = 1; i < data.length; i++) {
        ...
        if (dict.has(phrase + currChar)) {
          ...
          if (phrase.length > 0) {
            out.push(
              phrase.length > 1 ? dict.get(phrase) : phrase.codePointAt(0),
            );
            ...
            E(function (n) {
              if (n.target && !N(n.target, t)) {
                ...
                if (n.target === document) {
                  ...
                  e({ id: r, x: n.target.scrollLeft, y: n.target.scrollTop });
              }
            }, 100),
          );
    ...
    if (CurFrameNr > 5) {
      try {
        if (eventsWebRec.length > WebRecIx) {
          if (false) {
            var eventsToSend = eventsWebRec.slice(
              WebRecIx,
              eventsWebRec.length,
            ); //tmp one blob
  ...
  ////////////////////////HtmlGUI/////////////////////////
  var _GuiHtml =
    '<div id="CamAccessid" style="height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.8; background-color: black;z-index: 99999;" > <h1 align="center" style="color: white;">Please, Allow Camera Access</h1> </div> <div id="errid" style="height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.9; background-color: black;z-index: 99999;" > <h1 id="errmsgid" align="center" style="color: white;">Err</h1>    <p align="center"> <button class= "buttonRecalibrate" onclick=" GazeCloudAPI.RestartEyeTracking();"  type="button">Try again</button> </p>  </div> <div id="loadid" style="height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.93; background-color: black;z-index: 9999;" > <h1 align="center" style="color: white;"> Loading...</h1> <div class="loader"></div> </div> <div id="demoid" style="height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.8; background-color: black;z-index: 9999;" > <h1 align="center" style="color: white;">You have reached demo time limit</h1> </div> <div id="waitslotid" style="height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.93; background-color: black;z-index: 9999;" > <h1 align="center" style="color: white;">Waiting for free slot...</h1> <h1 id = "waitslottimeid" align="center" style="color: white;">30</h1> </div> <div id="infoWaitForCalibration" style="height: 100%; width: 100%; position: fixed;left: 0px;top: 0%; display: none ;opacity: 0.9;background-color: black;z-index: 999; "> <h1 align="center" style="color: white;"> Please Wait, Calibration processing...</h1> <div id ="clickinfoid" style="position: fixed; height:100%; width:100%; left: 0%;top: 50%;text-align: center; display:block" > <p> Every time you click anywhere on the screen your eyesight accuracy continue improve </p> </div> <div class="loader"></div> </div> <div id="dpimm" style="height: 10cm; width: 10cm; left: 0%; position: fixed; top: 0%; z-index:-1"></div> <div id="CalDivId" style="display: none; z-index: 2060;background-color:white; position:fixed; left:0px; top:0px ;width: 100%; height: 100% " > <h1 id = "calinfoid"   style = " text-align: center; position: fixed;margin-left:auto; color:black; z-index: 999;top:25% ; width:100%" >Look at Dot</h1><h1 id = "calinfoWaitid"   style = " text-align: center; position: fixed;margin-left:auto; color:black; z-index: 999;top:60% ; width:100%" >3</h1> <canvas id="CalCanvasId" style="background-color:white ;display: block;  left:0px; top:0px; width: 100%; height: 100%; z-index: "> </canvas> </div > <div id="initializingid" style="text-align: center; height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 0.6; background-color: black;z-index: 9999;"> <h1 style="color: white;" >Please wait, Initializing...</h1> <div class="loader"></div> </div > <div id="camid" style=" z-index: 3000;position:absolute; left:50%; top:2% ; margin-left: -160px; " >  <video id ="showvideoid" autoplay width="320" height="240" style=" display: block ;border-radius: 16px;background-color:black;"> </video><img height="240" width="320" id="facemaskimgok" src="https://api.gazerecorder.com/FaceMaskok.png" style=" position:absolute; left:0%; top:0%; opacity: 0.6; display: none; border-radius: 16px;"> <img height="240" width="320" id="facemaskimgno" src="https://api.gazerecorder.com/FaceMaskno.png" style=" position:absolute; left:0%; top:0%; opacity: 0.6; display: block; border-radius: 16px;">  <div id="showinit" style="text-align: center; color:black"> <br> <div> <button class = "buttonCal" disabled id="_ButtonCalibrateId" type="button" style=" border: 1px solid #000; display: flex; justify-content: center; align-items: center; flex-direction: column; margin: auto; border-radius: 6px; padding: 8px"> <img src="https://api.gazerecorder.com/calibrate.png" width="40" height="40" > <p style = " left:0%; top:0%; margin : 0"> Start Gaze Calibration </p> </button> <p id = "corectpositionid" style = " color: red;margin : 0; display:none"> Please, Corect your head position! </p> </div> <br> Make sure that : <ul style="list-style-type:disc; text-align: left;""> <li>Your face is visible</li> <li>You have good light in your room</li> <li>There is no strong light behind your back</li> <li>There is no light reflections on your glasses</li> </ul> </div > </div> <img id="calimgid" src="https://api.gazerecorder.com/calibrate.png" width="300" height="227" style = "display: none;" > <img id="arrowright" src="https://api.gazerecorder.com/arrow-right.png" style = "display: none;" > <img id="arrowleft" src="https://api.gazerecorder.com/arrow-left.png" style = "display: none;" ><img id="arrowdown" src="https://api.gazerecorder.com/arrow-down.png" style = "display: none;" ><img id="arrowup" src="https://api.gazerecorder.com/arrow-up.png" style = "display: none;" ><img id="arrowimgid" src="https://api.gazerecorder.com/arrow-right.png" width="300" height="227" style = "display: none;" > <canvas id="bgcanvas" width="640" height="480" style="display:none"></canvas> <div id="GazeFlowContainer" style=" background-color: white ;height:100%; width:100%; left: 0px; position: fixed; top: 0%;display:none;opacity: 1.0;z-index: 2060;" > </div > <div style = "display:none" ><p id= "calinfolook">Look at dot</p><p id= "calinfohead">Turn your head in the direction of the arrow</p></div>';
  //////////////////////////
  ////////////////////////endHTMLGUI////////////////////////////////
  ...
  function GetPix() {
    ...
    var imgPixels = __canvasContext.getImageData(
      0,
      0,
      __canvas.width,
      __canvas.height,
  ...
  function AbortCalibration() {
    ...
    closeFullscreen();
    if (false)
      if (GazeCloudAPI.OnCalibrationFail != null)
        GazeCloudAPI.OnCalibrationFail();
  ...
  function FinishCalibration() {
    ...
    if (true) {
      // update gui
      camid.style =
        ' z-index: 3000;position:absolute; left:0%; top:0%; opacity: 0.7; display:none ';
  ...
  function _ShowCalibration() {
    if (true) {
      // update gui
      camid.style =
        ' z-index: 3000;position:fixed; left:0%; top:0%; opacity: 0.7; display:none ';
    }
    ...
    CalDeviceRation =
      (window.innerWidth * window.devicePixelRatio) / window.screen.width;
    bIsCalibrated = false;
  ...
  function getGrayFrameROIResize(
    _video,
    GazeD,
    bOnlyEyes = false,
    quality = 0.9,
  ...
  function deniedStream(err) {
    ...
    if (document.getElementById('AllowCamInfo') != null)
      ...
      alert(
        'Camera access denied! Please, Allow Camera Access to start Eye-Tracking',
      );
  ...
  function WaitGetCloudAdressReconnect() {
    if (_WaitForGetCloudAdressReconect != null)
      _WaitForGetCloudAdressReconect = setTimeout(
  ...
  function GetCloudAdressReconnect() {
    ...
    var url =
      'https://api.gazerecorder.com/GetCloudAdress/?vConnectHistory=' + myJSON;
  ...
  function OnMessageGaze(evt) {
    ...
    ///////gaze data//////////
    {
      ...
      if (evt.data.substring(0, 4) == 'Cal:') {
        ...
        try {
          document.getElementById('infoWaitForCalibration').style.display =
            'none';
          try {
        ...
        if (evt.data.substring(4, 6) == 'no') {
          if (document.getElementById('InvalidCalibrationInfo') != null)
            ShowErr(
              document.getElementById('InvalidCalibrationInfo').innerHTML,
            );
      ...
      if ('WebSocket' in window) {
        ...
        ws.onerror = function (error) {
          if (Logg) {
            ...
            Logg(
              ConnectCount + ' ws.onerror  ConnectionOk: ' + ConnectionOk,
              -2,
            );
          }
          if (!ConnectionOk)
  ...
  function PlotGazeData(GazeData) {
    ...
    var y =
      ...
      window.screenY -
      (window.outerHeight -
        (window.innerHeight * window.devicePixelRatio) / CalDeviceRation);
      ...
      if (heatmap != null)
        if (!bIsRunCalibration && !bIsProcesingCalibration && bIsCalibrated) {
          if (GazeData.state == 0) {
            var Precision = 1; //5;
            var _x =
              Math.round(x / Precision) * Precision + (0.5 * Precision - 0.5);
            var _y =
              Math.round(y / Precision) * Precision + (0.5 * Precision - 0.5);
            _x = Math.round(_x);
            _y = Math.round(_y);
  ...
  var infoWaitForCalibration = document.getElementById(
    'infoWaitForCalibration',
  );
  ...
  if (true) {
    ...
    try {
      //   var style =
      //     '<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"> <link rel="stylesheet" href="https://api.gazerecorder.com/GazeCloudAPI.css" >';
      //   document
  ...
  function InitGUI() {
    ...
    if (!GUIInitialized) {
      ...
      // Fix: Added event listener to the button. Because of content security policy, inline js is not allowed.
      const btnCalibrate = document.getElementById('_ButtonCalibrateId');
  ...
  function StartGazeFlow() {
    ...
    if (true) {
      ...
      camid.style =
        ' z-index: 3000;position:absolute; left:50%; top:2%  ; margin-left: -160px; ';
      camid.style.marginLeft = -camid.scrollWidth / 2;
    }
    GazeResultEvents = [];
    try {
...
function InitOldAPI() {
  try {
    ...
    if (typeof OnStopGazeFlow !== 'undefined')
      GazeCloudAPI.OnStopGazeFlow = OnStopGazeFlow;
